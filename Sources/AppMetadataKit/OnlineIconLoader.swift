...
public actor OnlineIconLoader {
    public static let shared = OnlineIconLoader()
    ...
    public func iconData(from url: URL) async -> Data? {
        try? await iconData(from: url, minimumPixelSize: 128)
    }

    public func manualIconData(from url: URL) async throws -> Data {
    ...
    public func iconData(for homepage: URL) async -> Data? {
