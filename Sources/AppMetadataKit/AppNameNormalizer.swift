...
public enum AppNameNormalizer {
    ...
    public static func localCatalogDisplayName(for fileName: String) -> String {
    ...
    public static func groupingKey(for fileName: String) -> String {
        displayName(for: fileName)
            .folding(options: [.caseInsensitive, .diacriticInsensitive], locale: .current)
            .filter { $0.isLetter || $0.isNumber }
    }

    public static func localCatalogGroupingKey(for fileName: String) -> String {
        localCatalogDisplayName(for: fileName)
            .folding(options: [.caseInsensitive, .diacriticInsensitive], locale: .current)
            .filter { $0.isLetter || $0.isNumber }
    }

    public static func catalogIdentityKey(
        name: String,
        category: String,
        subcategory: String,
    ...
    public static func detectVersion(in fileName: String) -> String? {
